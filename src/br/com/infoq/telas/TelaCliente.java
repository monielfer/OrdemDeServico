...
public class TelaCliente extends javax.swing.JInternalFrame {
    ...
    private void adicionar(){
        ...
        String sql = "insert into tbclientes( nomecli, endcli, numcli, compcli, emailcli, cpfcli, fonecli, celcli, bairrocli) values (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        try {
            pst = conexao.prepareStatement(sql);
            ...
            pst.setString(9, txtBairro.getText().toUpperCase());
    ...
    private void alterar(){
        String sql = "update tbclientes set nomecli = ?, endcli = ?, numcli = ?, compcli = ?, emailcli = ?, cpfcli = ?, fonecli = ?, celcli = ?, bairrocli = ?  where idcli = ?";
        try {
             pst = conexao.prepareStatement(sql);
            pst.setString(1, txtNome.getText().toUpperCase());
            pst.setString(2, txtEnd.getText().toUpperCase());
            ...
            int apagado = pst.executeUpdate();
             if(apagado > 0){
                JOptionPane.showMessageDialog(null, "Registro Apagado com Sucesso!");
                 ...
                 JOptionPane.showMessageDialog(null, "Erro! Cliente Vinculado à uma Ordem de Serviço, favor remover a Ordem de Serviço Primeiro!");
            }
        }
    }
    ...
    public void setar_campos(){
        ...
        txtTel.setText(tblClientes.getModel().getValueAt(setar, 7).toString());
        txtCel.setText(tblClientes.getModel().getValueAt(setar, 8).toString());
        txtBairro.setText(tblClientes.getModel().getValueAt(setar, 9).toString());
